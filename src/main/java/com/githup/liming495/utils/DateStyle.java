...
public abstract class DateStyle {
    ...
    public static final String CT_SSS = "yyyy-MM-dd HH:mm:ss.SSS";
    ...
    public static final String CP_SSS = "yyyyMMddHHmmssSSS";
    ...
    public static final String CN_SSS = "yyyy年MM月dd日 HH时mm分ss秒SSS";
}
